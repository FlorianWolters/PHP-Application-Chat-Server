...
Contributions to **FlorianWolters\Application\Chat\Server** are always welcome.
...
Run the following commands to initially checkout **FlorianWolters\Application\Chat\Server**:

    md Chat-Server && cd Chat-Server
